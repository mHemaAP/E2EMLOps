...
with open(os.path.join( r'./checkpoints/classnames/sports.json' )) as class2idxfile:
    scls2lbs:dict = json.load(class2idxfile)
with open(os.path.join( r'./checkpoints/classnames/vegfruits.json' )) as class2idxfile:
...
demo.launch(share=False, debug=False,server_name="0.0.0.0",server_port=7860,enable_monitoring=False)