...
# python3 test_load_sports.py --url "http://a250c292ee6114b8e9d6f23f6d8690bc-1957734331.ap-south-1.elb.amazonaws.com/v1/models/sports-classifier:predict" --requests 20 --workers 4